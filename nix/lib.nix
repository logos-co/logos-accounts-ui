# Builds the logos-accounts-ui library
{ pkgs, common, src, logosAccountsModule, logosSdk }:
...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    if [ -f modules/accounts_ui.dylib ]; then
      cp modules/accounts_ui.dylib $out/lib/
    elif [ -f modules/accounts_ui.so ]; then
      cp modules/accounts_ui.so $out/lib/
    else
